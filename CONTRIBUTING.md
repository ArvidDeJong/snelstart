...
- The clients throw `SnelstartException` only, never a plain `RuntimeException`, and never wrap `Illuminate\Http\Client\ConnectionException`: host apps catch that class.
